 ...
 * @author alexa
 */
public class JformDemo extends javax.swing.JFrame {

    /**
     * Creates new form JformDemo
     */
    public JformDemo() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(result)
                    .addComponent(value1, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
                    .addComponent(value2))
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        int a = Integer.parseInt(value1.getText());
        int b = Integer.parseInt(value2.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JformDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
